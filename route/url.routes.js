...
import {shortenPostRequestBodySchema} from '../validation/user.validation.js';
...
const {url, code, validity} = validationResult.data

const shortCode =  code ?? nanoid(6);

const [result] = await dbInsertURL(req, shortCode, url, validity);
